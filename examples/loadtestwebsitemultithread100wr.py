...
# pytest loadtestwebsitemultithread100wr.py -s -n 100

# pytest loadtestwebsitemultithread100wr.py -s -n 100 --headless
...
class MyTestClass(BaseCase):
    ...
    def test_basic(self):
        for i in range(1):
            ...
            time.sleep(random.randint(2,5))  # Set wait timer between actions randomly between 2 and 5 seconds
